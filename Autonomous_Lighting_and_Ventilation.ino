...
String script_id = "AKfycbxBaaF1MPuxTe_CsXi9Nurt_dzslqOWSLqL-b3_wwQMxQ47cJVg";
...
void handle_OnConnect() 
{
  ...
  server.send(200, "text/html", SendHTML(temparature,humidity,CO2,Smoke)); 
}
...
String SendHTML(float temparature,float humidity,float CO2,float Smoke)
{
...
void sendData(float temparature,float humidity,float CO2,float Smoke, int val3)
{
  int a1=val3;
  Serial.print("Connecting to ");
  Serial.println(host);
  ...
  String url = "/macros/s/" + script_id + "/exec?output1=" + temparature + "&output2=" + humidity + "&output3=" + CO2 + "&output4=" + Smoke;
